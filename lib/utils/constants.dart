...
const String LOCATION_PERMISSION_PERMANENT_DENIED= "Location permissions are permanently denied, we cannot request permissions.";
const String LOCATION_SERVICE_DISABLED= "Location services are disabled. Please enable";
